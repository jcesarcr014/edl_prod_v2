...
class SFTP extends SSH2
{
    ...
    function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        $this->attributes = array(1 => 'NET_SFTP_ATTR_SIZE', 2 => 'NET_SFTP_ATTR_UIDGID', 4 => 'NET_SFTP_ATTR_PERMISSIONS', 8 => 'NET_SFTP_ATTR_ACCESSTIME', -1 << 31 => 'NET_SFTP_ATTR_EXTENDED');
        // http://tools.ietf.org/html/draft-ietf-secsh-filexfer-04#section-6.3
        // the flag definitions change somewhat in SFTPv5+.  if SFTPv5+ support is added to this library, maybe name
        // the array for that $this->open5_flags and similarly alter the constant names.
        $this->open_flags = array(1 => 'NET_SFTP_OPEN_READ', 2 => 'NET_SFTP_OPEN_WRITE', 4 => 'NET_SFTP_OPEN_APPEND', 8 => 'NET_SFTP_OPEN_CREATE', 16 => 'NET_SFTP_OPEN_TRUNCATE', 32 => 'NET_SFTP_OPEN_EXCL');
    ...
    function login($username)
    {
        ...
        $packet = pack('CNa*N3', NET_SSH2_MSG_CHANNEL_OPEN, strlen('session'), 'session', self::CHANNEL, $this->window_size, 16384);
...
' . 'exec sftp-server';
    ...
    function chmod($mode, $filename, $recursive = false)
    {
        ...
        $attr = pack('N2', NET_SFTP_ATTR_PERMISSIONS, $mode & 4095);
    ...
    function mkdir($dir, $mode = -1, $recursive = false)
    {
        ...
        // default permissions.
        $attr = $mode == -1 ? '    ' : pack('N2', NET_SFTP_ATTR_PERMISSIONS, $mode & 4095);
        if ($recursive) {
