...
');
    ...
    function _crc($data)
    {
        ...
        for ($i = 0; $i < $length; $i++) {
            ...
            $crc = $crc >> 8 & 16777215 ^ $crc_lookup_table[$crc & 255 ^ ord($data[$i])];
        }
