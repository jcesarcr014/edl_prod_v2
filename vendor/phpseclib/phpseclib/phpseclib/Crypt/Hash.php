...
class Hash
{
    ...
    {
        $this->setHash($hash);
        $this->ipad = str_repeat(chr(54), 128);
        $this->opad = str_repeat(chr(92), 128);
    }
    /**
    ...
    function hash($text)
    {
        ...
        $output = !empty($this->key) || is_string($this->key) ? hash_hmac($this->hash, $text, $this->key, true) : hash($this->hash, $text, true);
