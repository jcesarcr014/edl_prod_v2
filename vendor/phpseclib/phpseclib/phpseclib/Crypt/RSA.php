...
class RSA
{
    ...
    function _rsassa_pkcs1_v1_5_relaxed_verify($m, $s)
    {
        ...
        static $oids;
        if (!isset($oids)) {
            $oids = array('1.2.840.113549.2.2' => 'md2', '1.2.840.113549.2.4' => 'md4', '1.2.840.113549.2.5' => 'md5', '1.3.14.3.2.26' => 'id-sha1', '2.16.840.1.101.3.4.2.1' => 'id-sha256', '2.16.840.1.101.3.4.2.2' => 'id-sha384', '2.16.840.1.101.3.4.2.3' => 'id-sha512', '2.16.840.1.101.3.4.2.4' => 'id-sha224', '2.16.840.1.101.3.4.2.5' => 'id-sha512/224', '2.16.840.1.101.3.4.2.6' => 'id-sha512/256');
            ASN1::loadOIDs($oids);
        }
