...
-----END CERTIFICATE-----');
        ...
        $ext = chr(ASN1::TYPE_SEQUENCE | 32) . ASN1::encodeLength(strlen($ext)) . $ext;
...
-----END CERTIFICATE-----');
        ...
        $expected = array(array(array('utf8String' => 'Al. Marszałka Piłsudskiego 52/54'), array('utf8String' => '81-382 Gdynia'), array('utf8String' => 'Polska'), array('utf8String' => 'pomorskie')));
        $this->assertEquals($x509->getDNProp('id-at-postalAddress'), $expected);
        $expected = 'C=PL, O=Urząd Miasta Gdyni/serialNumber=PESEL: 61060603118, CN=Jerzy Przeworski/postalAddress=' . '0F\\X0C"AL. MARSZA\\XC5\\X82KA PI\\XC5\\X82SUDSKIEGO 52/54\\X0C\\X0D81-382 GDYNIA\\X0C\\X06POLSKA\\X0C\\X09POMORSKIE/givenName=Jerzy, SN=Przeworski';
