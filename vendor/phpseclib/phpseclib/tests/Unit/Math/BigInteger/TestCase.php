...
abstract class Unit_Math_BigInteger_TestCase extends PhpseclibTestCase
{
    ...
    {
        $x = $this->getInstance('8589934592');
        // 2**33
        $y = $this->getInstance('36893488147419103232');
        // 2**65
        $a = $x->multiply($y);
        // 2**98
        $b = $y->multiply($x);
    ...
    {
        $x = $this->getInstance('1180591620717411303425');
        // 2**70 + 1
    ...
    {
        if (getenv('TRAVIS') && PHP_VERSION === '5.3.3' && MATH_BIGINTEGER_MODE === \phpseclib\Math\BigInteger::MODE_INTERNAL) {
    ...
    {
        $bigInteger = new \phpseclib\Math\BigInteger('64000000');
        // (20^2)^3
    ...
    public function testPow()
    {
        ...
        $this->assertSame('64000000', (string) $bigInteger);
    }
