...
//$parameters->Enviroment = Parameters::ENVIROMENT_NOMINA;  // AMBIENTE DE NOMINA
//$parameters->Enviroment = Parameters::ENVIROMENT_DEFAULT; // PRODUCCION
$parameters->Enviroment = Parameters::ENVIROMENT_TEST;
