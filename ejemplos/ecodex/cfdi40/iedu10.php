...
InstitucionesEducativas10::CargarDatosTimbrado($electronicDocument);
...
if ($result == ProcessProviderResult::OK) {
    ...
    Html::showXml('CFDI 4.0 - INSTITUCIONES EDUCATIVAS 1.0', $xml, Descripcion::get(Descripcion::ECODEX_IEDU));
