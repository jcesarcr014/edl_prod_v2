...
require_once __DIR__ . '/../../Data/Complemento/ImpuestosLocales10.php';
...
use Facturando\EDL\Example\Data\Complemento\ImpuestosLocales10;
...
ImpuestosLocales10::CargarDatosTimbrado($electronicDocument);
...
if ($result == ProcessProviderResult::OK) {
    ...
    $electronicDocument->saveToFile('xml/impuestoslocales10.xml');
    $electronicDocument->Manage->Save->Options->Validations = true;

    Html::showXml('CFDI 4.0 - IMPUESTOS LOCALES 1.0', $xml, Descripcion::get(Descripcion::ECODEX_IMPUESTOS_LOCALES));
