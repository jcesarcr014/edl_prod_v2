...
require_once __DIR__ . '/../../Data/Complemento/HidrocarburosPetroliferos10.php';
...
use Facturando\EDL\Example\Data\Complemento\HidrocarburosPetroliferos10;
...
HidrocarburosPetroliferos10::CargarDatosTimbrado($electronicDocument);
...
if ($result == ProcessProviderResult::OK) {
    ...
    $electronicDocument->saveToFile('xml/HidrocarburosPetroliferos10.xml');
    $electronicDocument->Manage->Save->Options->Validations = true;

    Html::showXml('CFDI 4.0 - HIDROCARBUROS PETROLIFEROS 1.0', $xml, Descripcion::get(Descripcion::CFDI_HIDROCARBUROS_PETROLIFEROS));
