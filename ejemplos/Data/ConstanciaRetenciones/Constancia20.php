...
final class Constancia20
{
    // Este ejemplo se muestra el llena de los datos requeridos para timbrar una Constancia de retenciones 2.0
    /**
    ...
    public static function CargarDatosTimbrado($constanciaRetenciones)
    {
        ...
        //<editor-fold desc="CFDI Relacionado">
        ...
        $constanciaRetenciones->Data->Periodo->Ejercicio->Value = intval((new \DateTime('NOW'))->format('Y'));
        //</editor-fold>
    ...
    // Este ejemplo muestra como usar todas las clases y propiedades para una Constancia de retenciones 2.0
    /**
     * @param ConstanciaRetenciones $constanciaRetenciones
     */
    public static function CargarDatosCompleto($constanciaRetenciones)
    {
        ...
        //<editor-fold desc="Impuesto retenido 1">
        /** @var ImpuestoRetenido $impuestoRetenido */
        $impuestoRetenido = $constanciaRetenciones->Data->Totales->ImpuestosRetenidos->add();
        $impuestoRetenido->Base->Value = 16;
        $impuestoRetenido->Impuesto->Value = '001';
    ...
    public static function CargarDatosListas($constanciaRetenciones)
    {
        ...
        //<editor-fold desc="Receptor - Nacional">
        $constanciaRetenciones->Data->Receptor->Nacional->Rfc->Value = 'AAAD770905441';
        $constanciaRetenciones->Data->Receptor->Nacional->RazonSocial->Value = 'DARIO ALVAREZ ARANDA';
        $constanciaRetenciones->Data->Receptor->Nacional->Curp->Value = 'UXBA000419HYNVRDA3';
        $constanciaRetenciones->Data->Receptor->Nacional->DomicilioFiscal->Value = '07300';
        ...
        //<editor-fold desc="Impuesto retenido">
        for ($i = 1; $i <= 2; $i++) {
            /** @var ImpuestoRetenido $impuestoRetenido */
            $impuestoRetenido = $constanciaRetenciones->Data->Totales->ImpuestosRetenidos->add();
            $impuestoRetenido->Base->Value = 16;
