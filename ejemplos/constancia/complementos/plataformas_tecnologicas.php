...
require_once __DIR__ . '/../../Data/ConstanciaRetenciones/Complemento/PlataformasTecnologicas.php';
...
// Cargamos los datos
\Facturando\EDL\Example\Data\ConstanciaRetenciones\Complemento\PlataformasTecnologicas::CargarDatosCompleto($constanciaRetenciones);
...
if ($constanciaRetenciones->saveToString($xml))
{
    ...
    $constanciaRetenciones->saveToFile('../xml/constancia_retenciones_plataformas_tecnologicas.xml');

    Html::showXml('Constancia de retenciones 2.0 - Plataformas tecnologicas', $xml, Descripcion::get(Descripcion::CONSTANCIA_PLATAFORMAS_TECNOLOGICAS));
}
else{
