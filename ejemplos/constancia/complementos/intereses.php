...
require_once __DIR__ . '/../../Data/ConstanciaRetenciones/Complemento/Intereses.php';
...
// Cargamos los datos
\Facturando\EDL\Example\Data\ConstanciaRetenciones\Complemento\Intereses::CargarDatosCompleto($constanciaRetenciones);
...
if ($constanciaRetenciones->saveToString($xml))
{
    ...
    $constanciaRetenciones->saveToFile('../xml/constancia_retenciones_intereses.xml');

    Html::showXml('Constancia de retenciones 2.0 - Intereses', $xml, Descripcion::get(Descripcion::CONSTANCIA_INTERESES));
}
else{
