...
require_once __DIR__ . '/../../Data/ConstanciaRetenciones/Complemento/Premios.php';
...
// Cargamos los datos
\Facturando\EDL\Example\Data\ConstanciaRetenciones\Complemento\Premios::CargarDatosCompleto($constanciaRetenciones);
...
if ($constanciaRetenciones->saveToString($xml))
{
    ...
    $constanciaRetenciones->saveToFile('../xml/constancia_retenciones_premios.xml');

    Html::showXml('Constancia de retenciones 2.0 - Premios', $xml, Descripcion::get(Descripcion::CONSTANCIA_PREMIOS));
}
else{
