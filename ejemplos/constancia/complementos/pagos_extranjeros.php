...
require_once __DIR__ . '/../../Data/ConstanciaRetenciones/Complemento/PagosExtranjeros.php';
...
// Cargamos los datos
\Facturando\EDL\Example\Data\ConstanciaRetenciones\Complemento\PagosExtranjeros::CargarDatosCompleto($constanciaRetenciones);
...
if ($constanciaRetenciones->saveToString($xml))
{
    ...
    $constanciaRetenciones->saveToFile('../xml/constancia_retenciones_pagos_extranjeros.xml');

    Html::showXml('Constancia de retenciones 2.0 - Pagos a extranjeros', $xml, Descripcion::get(Descripcion::CONSTANCIA_PAGO_EXTRANJERO));
}
else{
