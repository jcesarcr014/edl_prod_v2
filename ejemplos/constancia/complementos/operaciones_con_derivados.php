...
require_once __DIR__ . '/../../Data/ConstanciaRetenciones/Complemento/OperacionesConDerivados.php';
...
// Cargamos los datos
\Facturando\EDL\Example\Data\ConstanciaRetenciones\Complemento\OperacionesConDerivados::CargarDatosCompleto($constanciaRetenciones);
...
if ($constanciaRetenciones->saveToString($xml))
{
    ...
    $constanciaRetenciones->saveToFile('../xml/constancia_retenciones_operaciones_con_derivados.xml');

    Html::showXml('Constancia de retenciones 2.0 - Operaciones con derivados', $xml,
        Descripcion::get(Descripcion::CONSTANCIA_OPERACIONES_CON_DERIVADO));
}
else{
