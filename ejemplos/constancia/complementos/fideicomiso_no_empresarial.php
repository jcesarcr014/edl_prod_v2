...
require_once __DIR__ . '/../../Data/ConstanciaRetenciones/Complemento/FideicomisoNoEmpresarial.php';
...
// Cargamos los datos
\Facturando\EDL\Example\Data\ConstanciaRetenciones\Complemento\FideicomisoNoEmpresarial::CargarDatosCompleto($constanciaRetenciones);
...
if ($constanciaRetenciones->saveToString($xml))
{
    ...
    $constanciaRetenciones->saveToFile('../xml/constancia_retenciones_fideicomiso_no_empresarial.xml');

    Html::showXml('Constancia de retenciones 2.0 - Fideicomiso no empresarial', $xml, Descripcion::get(Descripcion::CONSTANCIA_SECTOR_FINANCIERO));
}
else{
