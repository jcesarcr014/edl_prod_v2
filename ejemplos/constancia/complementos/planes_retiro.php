...
require_once __DIR__ . '/../../Data/ConstanciaRetenciones/Complemento/PlanesRetiro.php';
...
// Cargamos los datos
\Facturando\EDL\Example\Data\ConstanciaRetenciones\Complemento\PlanesRetiro::CargarDatosCompleto($constanciaRetenciones);
...
if ($constanciaRetenciones->saveToString($xml))
{
    ...
    $constanciaRetenciones->saveToFile('../xml/constancia_retenciones_planes_de_retiro.xml');

    Html::showXml('Constancia de retenciones 2.0 - Planes de retiro', $xml, Descripcion::get(Descripcion::CONSTANCIA_PLANES_RETIRO));
}
else{
