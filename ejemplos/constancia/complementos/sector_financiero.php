...
require_once __DIR__ . '/../../Data/ConstanciaRetenciones/Complemento/SectorFinanciero.php';
...
// Cargamos los datos
\Facturando\EDL\Example\Data\ConstanciaRetenciones\Complemento\SectorFinanciero::CargarDatosCompleto($constanciaRetenciones);
...
if ($constanciaRetenciones->saveToString($xml))
{
    ...
    $constanciaRetenciones->saveToFile('../xml/constancia_retenciones_sector_financiero.xml');

    Html::showXml('Constancia de retenciones 2.0 - Sector financiero', $xml, Descripcion::get(Descripcion::CONSTANCIA_SECTOR_FINANCIERO));
}
else{
