...
require_once __DIR__ . '/../../Data/ConstanciaRetenciones/Complemento/EnajenacionAcciones.php';
...
// Cargamos los datos
\Facturando\EDL\Example\Data\ConstanciaRetenciones\Complemento\EnajenacionAcciones::CargarDatosCompleto($constanciaRetenciones);
...
if ($constanciaRetenciones->saveToString($xml))
{
    ...
    $constanciaRetenciones->saveToFile('../xml/constancia_retenciones_enajenacion_acciones.xml');

    Html::showXml('Constancia de retenciones 2.0 - Enajenación de acciones', $xml, Descripcion::get(Descripcion::CONSTANCIA_ENAJENACION_ACCIONES));
}
else{
