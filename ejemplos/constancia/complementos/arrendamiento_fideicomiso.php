...
require_once __DIR__ . '/../../Data/ConstanciaRetenciones/Complemento/ArrendamientoFideicomiso.php';
...
// Cargamos los datos
\Facturando\EDL\Example\Data\ConstanciaRetenciones\Complemento\ArrendamientoFideicomiso::CargarDatosCompleto($constanciaRetenciones);
...
if ($constanciaRetenciones->saveToString($xml))
{
    ...
    $constanciaRetenciones->saveToFile('../xml/constancia_retenciones_arrendamiento_en_fideicomiso.xml');

    Html::showXml('Constancia de retenciones 2.0 - Arrendamiento en Fideicomiso', $xml,
        Descripcion::get(Descripcion::CONSTANCIA_ARRENDAMIENTO_EN_FIDEICOMISO));
}
else{
