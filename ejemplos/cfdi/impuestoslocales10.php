...
// Cargamos los datos
ImpuestosLocales10::CargarDatosCompleto($electronicDocument);
...
if ($electronicDocument->saveToString($xml)) {
    ...
    Html::showXml('CFDI 4.0 - IMPUESTOS LOCALES 1.0', $xml, Descripcion::get(Descripcion::CFDI_IMPUESTOS_LOCALES));
} else {
